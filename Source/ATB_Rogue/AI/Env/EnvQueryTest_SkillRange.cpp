...
void UEnvQueryTest_SkillRange::RunTest(FEnvQueryInstance& QueryInstance) const
{
	...
	UKismetSystemLibrary::SphereTraceMultiByProfile(QueryPawn, TargetPawn->GetActorLocation(), TargetPawn->GetActorLocation(),
		MaxThresholdValue, TEXT("EnemyTarget"), false, IgnoreActors, EDrawDebugTrace::None,
		HitResults, true);
	UKismetSystemLibrary::SphereTraceMultiByProfile(QueryPawn, TargetPawn->GetActorLocation(), TargetPawn->GetActorLocation(),
		MinThresholdValue, TEXT("EnemyTarget"), false, IgnoreActors, EDrawDebugTrace::None,
		HitResults, true);
	UKismetSystemLibrary::SphereTraceMultiByProfile(QueryPawn, TargetPawn->GetActorLocation(), TargetPawn->GetActorLocation(),
		1200.f, TEXT("EnemyTarget"), false, IgnoreActors, EDrawDebugTrace::None,
		HitResults, true);
